...
const MyDocs = () => {
  return (
    <> 
    <div>
    <h3 className=' text-6xl mt-16 font-sans font-bold mb-9'>My Docs</h3>
<div className="w-[60vw] mx-auto bg-white shadow-2xl rounded-lg overflow-hidden float-right">
