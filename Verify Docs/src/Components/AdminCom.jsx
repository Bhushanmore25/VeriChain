...
const AdminCom = () => {
    ...
    const ref3=useRef();
    const Aadhar=()=>{
        window.location.href = "/admin/protected/completed/addhar";
        
    }
    const Pancard=()=>{
        window.location.href = "/admin/protected/completed/pancard";

    }
    const Voter=()=>{
        window.location.href = "/admin/protected/completed/voterid";

    }
  return (
    <>
        <div>
    <h3 className=' text-6xl mt-16 font-sans font-bold mb-9'>Completed Docs</h3>
  ...
  <table className="min-w-full leading-normal">
    ...
    <tbody>
      <tr className="hover:bg-gray-100">
        ...
        <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm cursor-pointer" onClick={Aadhar} ref={ref1}>
        <FaArrowRight />
        </td>
      </tr>
      <tr className="hover:bg-gray-100">
        ...
        <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm cursor-pointer " onClick={Pancard} ref={ref2}>
        <FaArrowRight />
        </td>
      </tr>
      <tr className="hover:bg-gray-100">
        ...
        <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm cursor-pointer" onClick={Voter} ref={ref3}>
        <FaArrowRight />
        </td>
      </tr>
    </tbody>
