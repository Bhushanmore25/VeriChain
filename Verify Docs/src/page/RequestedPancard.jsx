...
const RequestedPancard = () => {
  return (
    <> <div>
        <AdminNavbar/>
    <h3 className=' text-6xl font-sans mt-4 font-semibold px-10 border-amber-500 border-b-4 pb-5 shadow-lg '>Pancard Requested</h3>
...
export default RequestedPancard